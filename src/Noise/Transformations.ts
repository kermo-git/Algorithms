import { shaderVecType, type NoiseDimension, type NoiseTransformNames } from './ShaderUtils'
...
export function octaveNoiseShader({ func_name, noise_name, dimension }: NoiseTransformNames) {
...
export function doubleWarp2DShader() {
    return /* wgsl */ `
        ${warp2DPosShader({
            func_name: 'warp_pos',
            noise_name: 'octave_noise',
        ...
        fn warp_noise(noise_pos: vec2f, warp_strength: f32, 
                    n_warp_octaves: u32, n_main_octaves: u32, 
                    persistence: f32) -> f32 {
            let warp1_pos = warp_pos(noise_pos, n_warp_octaves, persistence, warp_strength);
            let final_pos = warp_pos(warp1_pos, n_warp_octaves, persistence, warp_strength);
            return octave_noise(final_pos, n_main_octaves, persistence);
        }
    `
}
...
export function doubleWarp3DShader() {
    return /* wgsl */ `
        ${warp3DPosShader({
            func_name: 'warp_pos',
            noise_name: 'octave_noise',
